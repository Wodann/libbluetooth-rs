...
// HCI ioctl defines
pub const HCIDEVUP: u64 = request_code_write!('H', 201, mem::size_of::<i32>());
pub const HCIDEVDOWN: u64 = request_code_write!('H', 202, mem::size_of::<i32>());
pub const HCIDEVRESET: u64 = request_code_write!('H', 203, mem::size_of::<i32>());
pub const HCIDEVRESTAT: u64 = request_code_write!('H', 204, mem::size_of::<i32>());
pub const HCIGETDEVLIST: u64 = request_code_read!('H', 210, mem::size_of::<i32>());
pub const HCIGETDEVINFO: u64 = request_code_read!('H', 211, mem::size_of::<i32>());
pub const HCIGETCONNLIST: u64 = request_code_read!('H', 212, mem::size_of::<i32>());
pub const HCIGETCONNINFO: u64 = request_code_read!('H', 213, mem::size_of::<i32>());
pub const HCIGETAUTHINFO: u64 = request_code_read!('H', 215, mem::size_of::<i32>());
pub const HCISETRAW: u64 = request_code_write!('H', 220, mem::size_of::<i32>());
pub const HCISETSCAN: u64 = request_code_write!('H', 221, mem::size_of::<i32>());
pub const HCISETAUTH: u64 = request_code_write!('H', 222, mem::size_of::<i32>());
pub const HCISETENCRYPT: u64 = request_code_write!('H', 223, mem::size_of::<i32>());
pub const HCISETPTYPE: u64 = request_code_write!('H', 224, mem::size_of::<i32>());
pub const HCISETLINKPOL: u64 = request_code_write!('H', 225, mem::size_of::<i32>());
pub const HCISETLINKMODE: u64 = request_code_write!('H', 226, mem::size_of::<i32>());
pub const HCISETACLMTU: u64 = request_code_write!('H', 227, mem::size_of::<i32>());
pub const HCISETSCOMTU: u64 = request_code_write!('H', 228, mem::size_of::<i32>());
pub const HCIBLOCKADDR: u64 = request_code_write!('H', 230, mem::size_of::<i32>());
pub const HCIUNBLOCKADDR: u64 = request_code_write!('H', 231, mem::size_of::<i32>());
pub const HCIINQUIRY: u64 = request_code_read!('H', 240, mem::size_of::<i32>());
// HCI Packet types
