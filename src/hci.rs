...
// HCI ioctl defines
pub const HCIDEVUP: libc::c_ulong = request_code_write!('H', 201, mem::size_of::<i32>());
pub const HCIDEVDOWN: libc::c_ulong = request_code_write!('H', 202, mem::size_of::<i32>());
pub const HCIDEVRESET: libc::c_ulong = request_code_write!('H', 203, mem::size_of::<i32>());
pub const HCIDEVRESTAT: libc::c_ulong = request_code_write!('H', 204, mem::size_of::<i32>());
pub const HCIGETDEVLIST: libc::c_ulong = request_code_read!('H', 210, mem::size_of::<i32>());
pub const HCIGETDEVINFO: libc::c_ulong = request_code_read!('H', 211, mem::size_of::<i32>());
pub const HCIGETCONNLIST: libc::c_ulong = request_code_read!('H', 212, mem::size_of::<i32>());
pub const HCIGETCONNINFO: libc::c_ulong = request_code_read!('H', 213, mem::size_of::<i32>());
pub const HCIGETAUTHINFO: libc::c_ulong = request_code_read!('H', 215, mem::size_of::<i32>());
pub const HCISETRAW: libc::c_ulong = request_code_write!('H', 220, mem::size_of::<i32>());
pub const HCISETSCAN: libc::c_ulong = request_code_write!('H', 221, mem::size_of::<i32>());
pub const HCISETAUTH: libc::c_ulong = request_code_write!('H', 222, mem::size_of::<i32>());
pub const HCISETENCRYPT: libc::c_ulong = request_code_write!('H', 223, mem::size_of::<i32>());
pub const HCISETPTYPE: libc::c_ulong = request_code_write!('H', 224, mem::size_of::<i32>());
pub const HCISETLINKPOL: libc::c_ulong = request_code_write!('H', 225, mem::size_of::<i32>());
pub const HCISETLINKMODE: libc::c_ulong = request_code_write!('H', 226, mem::size_of::<i32>());
pub const HCISETACLMTU: libc::c_ulong = request_code_write!('H', 227, mem::size_of::<i32>());
pub const HCISETSCOMTU: libc::c_ulong = request_code_write!('H', 228, mem::size_of::<i32>());
pub const HCIBLOCKADDR: libc::c_ulong = request_code_write!('H', 230, mem::size_of::<i32>());
pub const HCIUNBLOCKADDR: libc::c_ulong = request_code_write!('H', 231, mem::size_of::<i32>());
pub const HCIINQUIRY: libc::c_ulong = request_code_read!('H', 240, mem::size_of::<i32>());
// HCI Packet types
