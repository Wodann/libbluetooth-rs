...
// BNEP ioctl defines
pub const BNEPCONNADD: u64 = request_code_write!('B', 200, std::mem::size_of::<c_int>());
pub const BNEPCONNDEL: u64 = request_code_write!('B', 201, std::mem::size_of::<c_int>());
pub const BNEPGETCONNLIST: u64 = request_code_read!('B', 210, std::mem::size_of::<c_int>());
pub const BNEPGETCONNINFO: u64 = request_code_read!('B', 211, std::mem::size_of::<c_int>());
pub const BNEPGETSUPPFEAT: u64 = request_code_read!('B', 212, std::mem::size_of::<c_int>());
