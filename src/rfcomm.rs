...
pub const RFCOMMCREATEDEV: c_int = request_code_write!('R', 200, std::mem::size_of::<c_int>());
pub const RFCOMMRELEASEDEV: c_int = request_code_write!('R', 201, std::mem::size_of::<c_int>());
pub const RFCOMMGETDEVLIST: c_int = request_code_read!('R', 210, std::mem::size_of::<c_int>());
pub const RFCOMMGETDEVINFO: c_int = request_code_read!('R', 211, std::mem::size_of::<c_int>());
